# Lovable Hackathon Submission — Cape Town 2.0
**Date:** 16 April 2026 | **Deadline:** 16:30

---

## Product Name
**KasiLink** — powered by Kopano Context

## Product Link
https://www.kasilink.com

## One-Line Pitch
KasiLink is a township gig marketplace that knows when the lights go out — connecting Cape Town workers with nearby jobs, no CV required, powered by the Kopano Context AI.

---

## Submission Description (for portal)

**KasiLink — Township Work, Reimagined for Cape Town's Reality**

Cape Town has a 31% unemployment rate and 57% youth joblessness. The gig economy could fix this — but every existing platform assumes a stable internet connection, a CV, a smartphone, and reliable power. None of those are guaranteed in Khayelitsha, Gugulethu, or Mitchells Plain.

KasiLink is built around three truths the market ignores:

**1. Proximity is economic.** Transport costs kill earnings. KasiLink matches workers within their suburb first — a car wash in Bellville goes to a Bellville worker, not someone who has to pay R30 taxi fare to get there.
...
- Suburb-first location matching across Cape Town, Johannesburg, and Soweto
- Verified provider profiles and community reviews
- Live load-shedding awareness + smart rescheduling suggestions on every gig post
- USSD fallback — works on any phone, no data required (Africa's Talking)
...
1. **kasilink.com** — homepage, township stats, utility widget
