...
export default function VerifiedProviderProfile({
  ...
  useEffect(() => {
    // Mock Provider Data Fetch (In reality, fetch from an /api/users/[id] endpoint)
    setTimeout(() => {
      setProvider({
        clerkId: id,
        ...
        about:
          "Professional plumber with 10+ years of experience in leak repairs, geyser installations, and general maintenance. Punctual and community trusted.",
      });
    }, 800);
