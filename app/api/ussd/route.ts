...
// OPTIMIZED USSD Gig Search Flow - KasiLink
...
export async function POST(req: NextRequest) {
  ...
  // ====================== 1. FIND GIGS NEAR ME ======================
    ...
    response = `CON Enter your suburb/area:\n(e.g. Soweto, Tembisa, Alexandra, Diepsloot)`;
  ...
  // User confirms application
    ...
    response = `CON Application sent!\n\nYou'll be notified if accepted.\nKasiLink Plus (R79/mo) gives priority matching & faster alerts.\n\n1. Find more gigs\n0. Main menu`;
    session.step = "main";
  }
